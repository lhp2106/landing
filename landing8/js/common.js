...
function getCapcha(){
    $.ajax({
        type: "POST",
        url: "http://portal.xeng.club/api?c=124",
...
function checkmobile(){
    ...
    if(isMobile.iOS() ){
        setTimeout(function(){location.href="https://xeng.club/download"} , 1);
    }
    else if(isMobile.Android() ){
        setTimeout(function(){location.href="http://android.xengclub.net"} , 1);
    }
    else{
        setTimeout(function(){location.href="http://xeng.club?a="+Base64.encode($("#username").val())+"&b="+Base64.encode(md5($("#password").val()))} , 1);
    }
}